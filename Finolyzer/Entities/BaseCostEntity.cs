...
public class ApplicationSystem : BaseCostEntity
{
    ...
    public virtual ICollection<ApplicationIntegrationKey> ApplicationIntegrationKeys { get; set; }
...
public class ApplicationIntegrationKey : AuditedAggregateRoot<int>
{
    public string Description { get; set; }
...
public class SystemIntegrationTransaction : AuditedAggregateRoot<int>
{
    ...
    public ApplicationIntegrationKey ApplicationIntegrationKey { get; set; }
