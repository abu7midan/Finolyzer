...
namespace Finolyzer.Migrations
{
    ...
    [Migration("20250820121552_fixintegrationkey")]
    partial class fixintegrationkey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finolyzer.Entities.ApplicationIntegrationKey", b =>
                {
                    ...
                    b.ToTable("ApplicationIntegrationKeys", (string)null);
                });
            ...
            modelBuilder.Entity("Finolyzer.Entities.IntegrationService", b =>
                {
                    ...
                    b.Property<string>("SystemMappingKey")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Finolyzer.Entities.SystemIntegrationTransaction", b =>
                {
                    ...
                    b.Property<int>("ApplicationIntegrationKeyId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Finolyzer.Entities.SystemIntegrationTransaction", b =>
                {
                    b.HasOne("Finolyzer.Entities.ApplicationIntegrationKey", "ApplicationIntegrationKey")
                        .WithMany()
                        .HasForeignKey("ApplicationIntegrationKeyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("ApplicationIntegrationKey");
            ...
            modelBuilder.Entity("Finolyzer.Entities.ApplicationSystem", b =>
                {
                    b.Navigation("ApplicationIntegrationKeys");
