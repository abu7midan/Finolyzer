...
namespace Finolyzer.Migrations
{
    ...
    [Migration("20250813111811_IntegrationKey")]
    partial class IntegrationKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finolyzer.Entities.ApplicatioIntegrationKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApplicatioIntegrationKeys", (string)null);
                });
            ...
            modelBuilder.Entity("Finolyzer.Entities.SystemIntegrationTransaction", b =>
                {
                    ...
                    b.Property<int>("ApplicatioIntegrationKeyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ApplicatioIntegrationKeyId");
            ...
            modelBuilder.Entity("Finolyzer.Entities.SystemIntegrationTransaction", b =>
                {
                    b.HasOne("Finolyzer.Entities.ApplicatioIntegrationKey", "ApplicatioIntegrationKey")
                        .WithMany()
                        .HasForeignKey("ApplicatioIntegrationKeyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("ApplicatioIntegrationKey");
            ...
            modelBuilder.Entity("Finolyzer.Entities.ApplicationSystem", b =>
                {
                    b.Navigation("ApplicatioIntegrationKeys");
